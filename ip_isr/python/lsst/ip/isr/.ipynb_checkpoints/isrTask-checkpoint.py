                ...
                if self.config.brighterFatterLevel == 'DETECTOR':
                    ...
                    if level == 'DETECTOR':
                        ...
                        self.log.warning("Making DETECTOR level kernel from AMP based brighter "
                                         "fatter kernels.")
                        if detector==9:
                            brighterFatterKernel.makeDetectorKernelFromAmpwiseKernels(detName, ampsToExclude=['C15','C16'])
                        else:
                            brighterFatterKernel.makeDetectorKernelFromAmpwiseKernels(detName)
                        #elif detector==23:
                        #    brighterFatterKernel.makeDetectorKernelFromAmpwiseKernels(detName, ampsToExclude=['C07', 'C11'])
